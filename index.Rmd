...
```{r prep_fancy_leaflet, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE}
library(jsonlite)
...
* Even better: use polygons to outline the countries instead of circle markers at their centers. See `addPolygons()`, `addGeoJSON()`, etc.
...
```{r googlevis1b, message=FALSE, echo=FALSE, cache=TRUE}
